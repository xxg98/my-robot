...
if __name__ == "__main__":
    tokenizer = AutoTokenizer.from_pretrained(r"C:\Users\yanyonghao\work\projects\Qwen-1_8B-Chat-Int4", trust_remote_code=True)
    model = AutoModelForCausalLM.from_pretrained(r"C:\Users\yanyonghao\work\projects\Qwen-1_8B-Chat-Int4", device_map="auto",
